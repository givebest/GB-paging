		...
		(function() {
		  ...
		  defaultConfig = {
			...
			GbPaging.prototype.getParams = function(opts) {
			    ...
			    args.isSEO = args.isSEO || defaultConfig.isSEO;
			}
			...
			GbPaging.prototype.events = function() {
				var _this = this,
					hashPram = parseUrl(args.goUrl, args.paramName);
